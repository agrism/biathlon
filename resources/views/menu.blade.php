    ...
    <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        >
            <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                <li>
                    <a
                        href="{{route('forecasts.summary.index')}}"
...
{{--                    </li>--}}
                    ...
                    @else
                    <li class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{!! \App\Helpers\LinkHelper::instance()->getLink(route: route('login'), name: 'Login') !!}</li>
                    @endif
                    </li>
            </ul>
        </div>
