...
<div class="relative inline-block group">
    ...
    @if($position === 'top')
        ...
        <div
            class="absolute invisible group-hover:visible opacity-0 group-hover:opacity-100 transition left-full top-1/2 -translate-y-1/2 ml-2 px-2 py-1 bg-gray-500 text-white text-xs rounded whitespace-nowrap">
            {{$text ?? ''}}
